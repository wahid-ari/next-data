...
export default function Github() {
  const [endpoint, setEndpoint] = useState('github')
      ...
      <main className="dark:bg-neutral-900 min-h-screen pb-8">
        ...
        <div className="sm:flex sm:flex-wrap min-h-screen max-w-5xl mx-auto">
          ...
          <div className="sm:w-4/5 px-4 mx-auto pt-4">
            <h1 className="dark:text-white text-2xl font-semibold">Github</h1>
            <div className="mt-4 mb-8 dark:text-white">
              <a href='#' className={linkClassName} onClick={() => setEndpoint('github')}>
                {process.env.API_URL}/api/github
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('github/vercel')}>
