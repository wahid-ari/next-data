...
export default function Prakerja() {
  const [endpoint, setEndpoint] = useState('prakerja')
      ...
      <main className="dark:bg-neutral-900 min-h-screen pb-8">
        ...
        <div className="sm:flex sm:flex-wrap min-h-screen max-w-5xl mx-auto">
          ...
          <div className="sm:w-4/5 px-4 mx-auto pt-4">
            <h1 className="dark:text-white text-2xl font-semibold">Prakerja</h1>
            <div className="mt-4 mb-8 dark:text-white">
              <a href='#' className={linkClassName} onClick={() => setEndpoint('prakerja')}>
                {process.env.API_URL}/api/prakerja
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('prakerja?name=dicoding')}>
