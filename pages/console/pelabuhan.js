...
export default function Pelabuhan() {
  const [endpoint, setEndpoint] = useState('pelabuhan')
      ...
      <main className="dark:bg-neutral-900 min-h-screen pb-8">
        ...
        <div className="sm:flex sm:flex-wrap min-h-screen max-w-5xl mx-auto">
          ...
          <div className="sm:w-4/5 px-4 mx-auto pt-4">
            <h1 className="dark:text-white text-2xl font-semibold">Pelabuhan</h1>
            <div className="mt-4 mb-8 dark:text-white">
              <a href='#' className={linkClassName} onClick={() => setEndpoint('pelabuhan')}>
                {process.env.API_URL}/api/pelabuhan
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('pelabuhan?kode=aat')}>
                {process.env.API_URL}/api/pelabuhan?kode=aat
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('pelabuhan?name=tanjung')}>
                {process.env.API_URL}/api/pelabuhan?name=tanjung
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('pelabuhan?location=surabaya')}>
