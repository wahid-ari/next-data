...
export default function Publisher() {
  const [endpoint, setEndpoint] = useState('publishers')
      ...
      <main className="dark:bg-neutral-900 min-h-screen pb-8">
        ...
        <div className="sm:flex sm:flex-wrap min-h-screen max-w-5xl mx-auto">
          ...
          <div className="sm:w-4/5 px-4 mx-auto pt-4">
            <h1 className="dark:text-white text-2xl font-semibold">Publisher</h1>
            <div className="mt-4 mb-8 dark:text-white">
              <a href='#' className={linkClassName} onClick={() => setEndpoint('publishers')}>
                {process.env.API_URL}/api/publishers
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('publishers?name=balai')}>
                {process.env.API_URL}/api/publishers?name=balai
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('publishers?area=6')}>
                {process.env.API_URL}/api/publishers?area=6
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('publishers?area=3&area=6')}>
                {process.env.API_URL}/api/publishers?area=3&area=6
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('publishers?registered_year_start=2018')}>
                {process.env.API_URL}/api/publishers?registered_year_start=2018
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('publishers?registered_year_end=1980')}>
                {process.env.API_URL}/api/publishers?registered_year_end=1980
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('publishers?registered_year_start=2017&registered_year_end=2018')}>
                {process.env.API_URL}/api/publishers?registered_year_start=2017&registered_year_end=2018
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('publishers?count_only=true')}>
                {process.env.API_URL}/api/publishers?count_only=true
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('publishers?name=balai&count_only=true')}>
                {process.env.API_URL}/api/publishers?name=balai&count_only=true
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('publishers?area=7&registered_year_end=1995')}>
                {process.env.API_URL}/api/publishers?area=7&registered_year_end=1995
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('publishers?name=bintang&registered_year_start=2010&registered_year_end=2020')}>
                {process.env.API_URL}/api/publishers?name=bintang&registered_year_start=2010&registered_year_end=2020
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('publishers?area=5&area=6&count_only=true')}>
