...
export default function Emiten() {
  const [endpoint, setEndpoint] = useState('emiten')
      ...
      <main className="dark:bg-neutral-900 min-h-screen pb-8">
        ...
        <div className="sm:flex sm:flex-wrap min-h-screen max-w-5xl mx-auto">
          ...
          <div className="sm:w-4/5 px-4 mx-auto pt-4">
            <h1 className="dark:text-white text-2xl font-semibold">Emiten</h1>
            <div className="mt-4 mb-8 dark:text-white">
              <a href='#' className={linkClassName} onClick={() => setEndpoint('emiten')}>
                {process.env.API_URL}/api/emiten
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('emiten?kode=aali')}>
                {process.env.API_URL}/api/emiten?kode=aali
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('emiten?name=astra')}>
                {process.env.API_URL}/api/emiten?name=astra
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('emiten?category=pengembangan')}>
                {process.env.API_URL}/api/emiten?category=pengembangan
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('emiten?kode=ab&category=pengembangan')}>
