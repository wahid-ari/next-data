...
export default function Spotify() {
  const [endpoint, setEndpoint] = useState('spotify')
      ...
      <main className="dark:bg-neutral-900 min-h-screen pb-8">
        ...
        <div className="sm:flex sm:flex-wrap min-h-screen max-w-5xl mx-auto">
          ...
          <div className="sm:w-4/5 px-4 mx-auto pt-4">
            <h1 className="dark:text-white text-2xl font-semibold">Spotify</h1>
            <div className="mt-4 mb-8 dark:text-white">
              <a href='#' className={linkClassName} onClick={() => setEndpoint('spotify')}>
                {process.env.API_URL}/api/spotify
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('spotify/artist')}>
                {process.env.API_URL}/api/spotify/artist
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('spotify/albums')}>
                {process.env.API_URL}/api/spotify/albums
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('spotify/albums/bintang-di-surga')}>
                {process.env.API_URL}/api/spotify/albums/bintang-di-surga
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('spotify/tracks')}>
                {process.env.API_URL}/api/spotify/tracks
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('spotify/tracks/bintang-di-surga')}>
