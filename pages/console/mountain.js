...
export default function Mountain() {
  const [endpoint, setEndpoint] = useState('mountains')
      ...
      <main className="dark:bg-neutral-900 min-h-screen pb-8">
        ...
        <div className="sm:flex sm:flex-wrap min-h-screen max-w-5xl mx-auto">
          ...
          <div className="sm:w-4/5 px-4 mx-auto pt-4">
            <h1 className="dark:text-white text-2xl font-semibold">Mountain</h1>
            <div className="mt-4 mb-8 dark:text-white">
              <a href='#' className={linkClassName} onClick={() => setEndpoint('mountains')}>
                {process.env.API_URL}/api/mountains
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('mountains?type=stratovulkan')}>
                {process.env.API_URL}/api/mountains?type=stratovulkan
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('mountains?max_height=1000')}>
                {process.env.API_URL}/api/mountains?max_height=1000
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('mountains?min_height=3000')}>
                {process.env.API_URL}/api/mountains?min_height=3000
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('mountains?min_height=2500&max_height=3000')}>
                {process.env.API_URL}/api/mountains?min_height=2500&max_height=3000
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('mountains?type=stratovulkan&max_height=3000')}>
                {process.env.API_URL}/api/mountains?type=stratovulkan&max_height=3000
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('mountains?type=stratovulkan&min_height=2500&max_height=3000')}>
