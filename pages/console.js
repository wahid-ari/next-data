...
export default function Heroes() {
  const [endpoint, setEndpoint] = useState('heroes')
      ...
      <main className="dark:bg-neutral-900 min-h-screen pb-8">
        ...
        <div className="sm:flex sm:flex-wrap min-h-screen max-w-5xl mx-auto">
          ...
          <div className="sm:w-4/5 px-4 mx-auto pt-4">
            <h1 className="dark:text-white text-2xl font-semibold">Heroes</h1>
            <div className="mt-4 mb-8 dark:text-white">
              <a href='#' className={linkClassName} onClick={() => setEndpoint('heroes')}>
                {process.env.API_URL}/api/heroes
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('heroes?name=Abdurrahman%20Baswedan')}>
                {process.env.API_URL}/api/heroes?name=Abdurrahman%20Baswedan
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('heroes?q=angkatan')}>
                {process.env.API_URL}/api/heroes?q=angkatan
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('heroes?alive_start=1900&alive_end=1945')}>
                {process.env.API_URL}/api/heroes?alive_start=1900&alive_end=1945
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('heroes?birth_start=1920&birth_end=1925')}>
                {process.env.API_URL}/api/heroes?birth_start=1920&birth_end=1925
              </a>
              <a href='#' className={linkClassName} onClick={() => setEndpoint('heroes?ascend_start=2000&ascend_end=2005')}>
